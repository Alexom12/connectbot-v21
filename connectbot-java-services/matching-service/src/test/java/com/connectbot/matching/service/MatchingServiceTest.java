...
class MatchingServiceTest {
    ...
    void setUp() {
        ...
        testEmployees = Arrays.asList(
                new Employee(1L, "Иван Иванов", "Разработчик", "IT", "БЦ1", 123L, "ivan",
                        Arrays.asList("coffee", "chess"), true),
                new Employee(2L, "Петр Петров", "Аналитик", "Analytics", "БЦ1", 124L, "petr",
                        Arrays.asList("coffee", "lunch"), true),
                new Employee(3L, "Мария Сидорова", "Дизайнер", "Design", "БЦ2", 125L, "maria",
                        Arrays.asList("coffee", "photo"), true),
                new Employee(4L, "Алексей Алексеев", "Менеджер", "Management", "БЦ2", 126L, "alex",
                        Arrays.asList("lunch", "games"), true));
    }
