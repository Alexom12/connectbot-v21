...
📊 Используйте /admin_stats для просмотра статистики по активностям.
        ...
        await update.message.reply_text(activities_text, parse_mode='Markdown')
...
⚠️ Для экстренной остановки встречи используйте /admin_emergency_stop
        ...
        await update.message.reply_text(meetings_text, parse_mode='Markdown')
...
• /admin_users_stats - Статистика по пользователям

🔐 Для назначения администраторов обратитесь к супер-администратору.
        """
